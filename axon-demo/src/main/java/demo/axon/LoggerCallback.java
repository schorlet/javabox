...
public final class LoggerCallback implements CommandCallback<Object, Object> {
    ...
    @Override
    public void onSuccess(final Object result, final CommandContext<Object> context) {
        logger.debug("[Success] {}", string(context.getCommand()));
    }

    @Override
    public void onFailure(final Throwable cause, final CommandContext<Object> context) {
