 ...
 * CellProxyEditor
 */
public class CellProxyEditor extends ResizeComposite implements Editor<CellProxy> {
    @UiTemplate("CellProxyEditor.ui.xml")
    public interface ViewBinder extends UiBinder<Widget, CellProxyEditor> {}
    ...
    @Inject
    CellProxyEditor(final ViewBinder uiBinder, final Resources resources) {
